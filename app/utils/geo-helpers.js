...
export function locationDistanceFromZone(location, zone) {
...
export function locationInZone(location, zone) {
  let dist = locationDistanceFromZone(location, zone);
  let range = zone.get('range');
  return dist < range;
};